...
hdb_log_set_non_str_attribute "ScalingFactor" 10
...
hdb_start_benchmark "column_benchmark_none" true "NONE" "none"
run_all_benchmarks "/usr/sap/HXE/HDB90/work" $repetitions
hdb_end_benchmark

hdb_start_benchmark "column_benchmark_none_noolap" true "NONE" "NO_USE_OLAP_PLAN"
run_all_benchmarks_no_olap "/usr/sap/HXE/HDB90/work" $repetitions
hdb_end_benchmark

hdb_start_benchmark "column_benchmark_none_olap" true "NONE" "USE_OLAP_PLAN"
...
hdb_start_benchmark "benchmark_fakten" $column "FAKTENONLY" "none"
run_all_benchmarks "/usr/sap/HXE/HDB90/work" $repetitions
hdb_end_benchmark

hdb_start_benchmark "benchmark_fakten_noolap" $column "FAKTENONLY" "NO_USE_OLAP_PLAN"
run_all_benchmarks_no_olap "/usr/sap/HXE/HDB90/work" $repetitions
hdb_end_benchmark

hdb_start_benchmark "benchmark_faktenk_olap" $column "FAKTENONLY" "USE_OLAP_PLAN"
run_all_benchmarks_olap "/usr/sap/HXE/HDB90/work" $repetitions
